globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, assertMethod, readBody, setCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/gustavo-h-s-santos/Documents/Coffe/client/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabase": {
      "url": "https://romrgqhibqlgdfjtfrle.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJvbXJncWhpYnFsZ2RmanRmcmxlIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODM0NTk0NjMsImV4cCI6MTk5OTAzNTQ2M30.z_OhnKqnQTXMXnoXUva8piR-C5RwknGpD9edzCkow0U",
      "client": {},
      "redirect": false,
      "cookies": {
        "name": "sb",
...
const serverAssets = [{"baseName":"server","dir":"/home/gustavo-h-s-santos/Documents/Coffe/client/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/gustavo-h-s-santos/Documents/Coffe/client","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/gustavo-h-s-santos/Documents/Coffe/client/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/gustavo-h-s-santos/Documents/Coffe/client/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/gustavo-h-s-santos/Documents/Coffe/client/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _MMjcnpm8sh = (function(nitro) {
...
const _YOIaIH = defineEventHandler(async (event) => {
...
const _lazy_K09uoB = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_K09uoB, lazy: true, middleware: false, method: undefined },
  { route: '/api/_supabase/session', handler: _YOIaIH, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_K09uoB, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/gustavo-h-s-santos/Documents/Coffe/client/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/gustavo-h-s-santos/Documents/Coffe/client/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
